      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Button
              className="group glass-card bg-keja-accent/15 hover:bg-keja-accent/25 text-white border-keja-accent/20 hover:border-keja-accent/40 px-8 py-6 text-lg flex items-center gap-3 transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 font-medium"
