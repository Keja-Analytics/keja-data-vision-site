  ...
  return (
    <section className="pt-32 md:pt-40 pb-20 md:pb-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-keja-accent/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-keja-copper/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          <div className={`space-y-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-keja-cream leading-tight max-w-6xl mx-auto">
              Transform Your Business with{" "}
              <span className="font-medium text-keja-accent bg-gradient-to-r from-keja-accent to-keja-copper bg-clip-text text-transparent">AI Solutions</span>
              {" "}&{" "}
              <span className="font-medium text-keja-copper bg-gradient-to-r from-keja-copper to-keja-accent bg-clip-text text-transparent">Data Intelligence</span>
            </h1>
            <p className="text-lg md:text-xl text-keja-light max-w-4xl mx-auto font-light leading-relaxed">
