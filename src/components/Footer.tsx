...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-keja-gray bg-keja-light pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-keja-primary">Keja Analytics</h2>
            <p className="mt-2 text-keja-secondary max-w-md">
          ...
          <div className="flex items-center space-x-4">
            <a 
              ...
              className="text-keja-secondary hover:text-keja-accent transition-colors"
              aria-label="LinkedIn"
            >
        ...
        <div className="border-t border-keja-gray pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-keja-secondary text-sm">
            &copy; {currentYear} Keja Analytics. All rights reserved.
          </p>
          
          <div className="mt-4 md:mt-0">
            <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-keja-secondary">
